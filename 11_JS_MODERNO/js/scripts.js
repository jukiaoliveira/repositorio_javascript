...
const users = [
    {name: "Giovana", available: true},
    {name: "Ingrid", available: false},
    {name: "Pablo", available: true},
    {name: "Maria Clara", available: false},
    {name: "Kaike", available: true},
]
...
const products = [
    ...
    { name: "Fogão", price: 499, category: "Roupas "},
    { name: "Calça Jeans", price: 87.99, category: "Eletro"},
];
